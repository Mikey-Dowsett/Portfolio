<template>
  ...
  <GameCard
    ...
    src="/src/assets/gameimages/fightforearth.png"
  ...
  <GameCard
    title="Math Sweeper"
    src="/src/assets/gameimages/mathsweeper.png"
    desc="Math Sweeper started as an attempt to recreate the original minesweeper. I created a randomly generating system that creates a certain amount of bombs when the player clicks their first tile, ensuring they always get one free tile. Once I had the main system done and working exactly like the original minesweeper I decided to add my own spin to it. I decided to give the player a chance to keep playing when they clicked a bomb. All they had to do was solve a math problem. Then I created a difficulty system off of that where each difficulty added more bombs and made the math harder by using bigger numbers."
    link="https://dark-horn-games.itch.io/mathsweeper"
    tags="August 2022,Unity,Aseprite,freesound.org"
  />
  <GameCard
    title="Farmers Apocalypse"
    src="/src/assets/gameimages/farmersapocalypse.png"
  ...
  <GameCard
    title="Mahara"
    src="/src/assets/gameimages/mahara.png"
  ...
  <GameCard
    title="Dwarf Dash"
    src="/src/assets/gameimages/dwarfdash.png"
    desc="Dwarf Dash is a recreation of the first game, but still one of my first projects. I made it while following a tutorial by BlackThornProd. It is very similar to the original but I added the ability to unlock new characters and backgrounds. The game play is very simple, avoid the falling boulders for as long as you can. Some shields fall occasionally giving you one free hit from a boulder. The longer you last the more points you get, which can be used to unlock the other characters and backgrounds. Each character has slightly different heights and speeds, giving each their own advantage and disadvantage. This is one of my first games, and it shows. The UI is very simple and doesn't look good, and the game play is very clunky."
